...
export class OrderService {
  ...
  private API_URL_LOCATION="http://localhost:3000/loc";
  ...
  setLocation(location):Observable<Location> {
    ...
    return this.httpClient
      .post<Location>(`${this.API_URL_LOCATION}/`, location, { headers: headers })
      .pipe(map(res => res));
  }
  ...
  getLocation():Observable<Location> {
    ...
    return this.httpClient
      .get<Location>(`${this.API_URL_LOCATION}/`, { headers: headers })
      .pipe(map(res => res));
  }
  //------------------------------------------------//
  // unused
